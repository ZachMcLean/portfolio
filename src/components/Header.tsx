		...
		<header className="z-[999] relative">
			...
			<motion.div
				className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border 
					border-white border-opacity-25 bg-white bg-opacity-25 shadow-lg 
					shadow-black/[0.03] backdrop-blur-[0.2rem] 
					dark:bg-gray-950 dark:border-black/10 dark:bg-opacity-25"
				// className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border
				...
				>
					...
					{links.map((link) => (
						...
						>
							<Link
								className={clsx(
									"flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-350 dark:hover:text-gray-100",
									{
